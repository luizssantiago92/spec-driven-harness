...
**Who this is for:** anyone who wonders *“what does Spec Seatbelt actually enforce?”*
...
| **Specify before Verify** | You can’t “finish” without a written plan the seatbelt can check against. |
...
**Rule of thumb:** if it isn’t in the freeze table or the gate scripts, don’t promise users that Spec Seatbelt “guarantees” it.
