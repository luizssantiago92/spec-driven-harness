...
export const REFERENCE_ASSETS = [
  ...
  { file: "chatprd-sync.md", remotePath: "skills/references/chatprd-sync.md" },
];
...
- \`.cursor/skills/references/\` — phase procedures (explore, constitution, specify, discuss, design, tasks, analyze, implement, validate, converge, archive, memory, quick-mode, context-limits, lessons, sub-agents)
...
- \`.specs/harness/scripts/analyze_artifacts.py\` before approving tasks (cross-artifact)
...
function assertAllowedAssetUrl(raw) {
  ...
  try {
    ...
    throw new Error(`Invalid harness asset URL: ${raw}`);
  }
