...
- \`.cursor/skills/references/\` — phase procedures (specify, discuss, design, tasks, implement, validate, memory, quick-mode, context-limits, lessons, sub-agents)
...
- \`.cursor/skills/appsec.md\` — conditional AppSec (Complex / attack surface); never with qa-strategy at once
 ...
 * @returns {string}
 */
export function assertSafeDownloadUrl(raw) {
